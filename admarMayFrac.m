...
Prenam = strcat('/Users/nolte/ABCs/Apps/CUSSP/CSouRec/CSou',num2str(Sou),'_Rec',num2str(Rec),'_');
...
[dlnet,stat] = TripletAMargin(XTrain,YTrain,XValid,YValid,Iput);
...
Printfile2('distaMay.txt',xx,dista)
