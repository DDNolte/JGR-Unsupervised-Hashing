...
% Remove the balancing (this will crash lower down, but after the Sim mat is generated)
% ZeroFractmp = ZeroFrac;
% OneFractmp = OneFrac;
% TwoFractmp = TwoFrac;
% TwoFrac2tmp = TwoFrac2;
...
Fracg = concatmat(Fracg,TestSetg,1);
fraclass = concat(fraclass,Yfraclass);
...
tic
[dlnet1,dlnet2] = TsiaMae(XTrain,YTrain,Nrepdim,Nhidnodes,validFraction,numIterations,miniBatchSize,wtinit);  % Training function call
toc
